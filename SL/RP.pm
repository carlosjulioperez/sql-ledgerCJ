...
sub aging {
  ...
  my %interval = ( 'Pg' => {
			...
			'c15' => "(date '$form->{todate}' - interval '0 days')",
			'c30' => "(date '$form->{todate}' - interval '15 days')",
			'c45' => "(date '$form->{todate}' - interval '45 days')",
			'c60' => "(date '$form->{todate}' - interval '30 days')",
			'c90' => "(date '$form->{todate}' - interval '60 days')",
			'c91' => "(date '$form->{todate}' - interval '90 days')" },
		  'DB2' => {
  ...
  if ($form->{employee}){
     $where .= qq| AND a.employee_id = $form->{employee_id}|;
  }
  ...
  my %c = (c0 => { flds => '(a.amount - a.paid) AS c0, 0.00 AS c15, 0.00 AS c30, 0.00 AS c45, 0.00 AS c60, 0.00 AS c90, 0.00 AS c91' },
           c15 => { flds => '0.00 AS c0, (a.amount - a.paid) AS c15, 0.00 AS c30, 0.00 AS c45, 0.00 AS c60, 0.00 AS c90, 0.00 AS c91' },
           c30 => { flds => '0.00 AS c0, 0.00 AS c15, (a.amount - a.paid) AS c30, 0.00 AS c45, 0.00 AS c60, 0.00 AS c90, 0.00 AS c91' },
           c45 => { flds => '0.00 AS c0, 0.00 AS c15, 0.00 AS c30, (a.amount - a.paid) AS c45, 0.00 AS c60, 0.00 AS c90, 0.00 AS c91' },
           c60 => { flds => '0.00 AS c0, 0.00 AS c15, 0.00 AS c30, 0.00 AS c45, (a.amount - a.paid) AS c60, 0.00 AS c90, 0.00 AS c91' },
           c90 => { flds => '0.00 AS c0, 0.00 AS c15, 0.00 AS c30, 0.00 AS c45, 0.00 AS c60, (a.amount - a.paid) AS c90, 0.00 AS c91' },
           c91 => { flds => '0.00 AS c0, 0.00 AS c15, 0.00 AS c30, 0.00 AS c45, 0.00 AS c60, 0.00 AS c90, (a.amount - a.paid) AS c91' }
	  );
  
  my @c = ();

  for (qw(c0 c15 c30 c45 c45 c60 c90 c91)) {
    if ($form->{$_}) {
      push @c, $_;
    }
  }
  ...
  if ($item > 0) {
    $c{$c[0]}{and} = qq|
    	  AND (
		  a.$transdate >= $interval{$myconfig->{dbdriver}}{$c[1]}
 	      )|;
  }
