...
<table width=100%>
  ...
  <tr>
    <td>
      <table width=100%>
 	<!-- armaghan 26-oct-2007 Added accno to list single account activity from search page -->
	<tr>
...
sub transactions {
  ...
  @columns = $form->sort_columns(qw(transdate id reference description name vcnumber address notes lineitem source memo debit credit accno gifi_accno accdescription department));
  ...
  $column_header{accdescription} = "<th>".$locale->text('Account Description')."</th>";
